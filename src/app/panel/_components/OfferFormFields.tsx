...
type Props = {
   ...
   */
  formId?: string;
  /** Czy chowamy domyślny przycisk „Zapisz" wewnątrz formularza (gdy ma go sticky save bar). */
...
export function OfferFormFields({ action, agents, defaults, submitLabel, formId, hideInlineSubmit }: Props) {
  const d = defaults ?? {};

  return (
    <form id={formId} action={action} className="space-y-10 max-w-4xl">
