      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-3">
        {images.map((src, i) => (
          <button
            ...
            className="group relative aspect-[4/5] overflow-hidden rounded-[var(--radius-md)] bg-ink-100 ring-1 ring-ink-200/80 transition-shadow duration-300 hover:shadow-[var(--shadow-soft)] focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2"
